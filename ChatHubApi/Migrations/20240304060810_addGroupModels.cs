    ...
    public partial class addGroupModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGroupMatchings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGroupMatchings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserGroupMatchings_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGroupMatchings_GroupId",
                table: "UserGroupMatchings",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGroupMatchings_UserId",
                table: "UserGroupMatchings",
                column: "UserId");
